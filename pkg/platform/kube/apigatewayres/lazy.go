...
func (lc *lazyClient) enrichPrimaryIngressResources(primaryIngressResources *ingress.Resources,
	...
	lc.logger.WarnWith("KAWABANGA - remove configuration snippet annotation from ingress",
		"name",primaryIngressResources.Ingress.Name)
	delete(annotations, common.NginxConfigurationSnippetAnnotationKey)
